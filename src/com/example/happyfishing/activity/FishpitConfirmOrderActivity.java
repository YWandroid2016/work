...
public class FishpitConfirmOrderActivity extends Activity implements
		OnClickListener {
		...
		mainHandler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				case 1:
					...
					Toast.makeText(FishpitConfirmOrderActivity.this,
							statusText, Toast.LENGTH_SHORT).show();
					break;
				case 5:
					Toast.makeText(FishpitConfirmOrderActivity.this, "网络连接错误",
	...
	private void loadData(String dateString) {
		...
		HttpUtil.getJSON(HttpAddress.ADDRESS + HttpAddress.PROJECT
				+ HttpAddress.CLASS_MERCHANT + HttpAddress.METHOD_RESERVED,
					...
					public void onFinish(Object response) {
						...
						try {
							...
							runOnUiThread(new Runnable() {
								public void run() {
									adapter3 = new FishPositionShowAdapter(
											FishpitConfirmOrderActivity.this,
											28, 0, orderedLocations);
									adapter3.setCurrentOrder(-1);
									grv_fishpitorder_position
											.setAdapter(adapter3);
	...
	private void initView() {
		...
		findViewById(R.id.tv_fishpitconfirmorder_confirm).setBackgroundColor(
		...
		adapter2 = new FishPositionGroupNumAdapter(
				FishpitConfirmOrderActivity.this, groupNum, fishPositionTotal);

		// grv_fishipitoder_date = (GridView)
		// findViewById(R.id.grv_fishipitorder_date);
		...
		actionBar_fishipit_confirm.setActionBar(R.string.back, -1,
				R.string.title_actionbar_fishpit_detail, this);
		findViewById(R.id.tv_fishpitconfirmorder_confirm).setOnClickListener(
				this);
		tv_fishpit_confirm_fishPositionTotal = (TextView) findViewById(R.id.tv_fishipit_confirm_fishPositionTotal);
		tv_fishpit_confirm_fishPositionTotal.setText("共 " + fishPositionTotal
				+ " 个钓位");

		grv_fishpitorder_position = (GridView) findViewById(R.id.grv_fishpitorder_position);
		grv_fishpitorder_position.setSelector(new ColorDrawable(
				Color.TRANSPARENT));
		grv_fishpitorder_position
				.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
						...
						if ((Boolean) view.getTag()) {
							findViewById(R.id.tv_fishpitconfirmorder_confirm)
									.setEnabled(true);
							findViewById(R.id.tv_fishpitconfirmorder_confirm)
									.setBackgroundColor(
											getResources()
							...
							if (null != positionView) {
								TextView tv_groupNum = (TextView) positionView
										.findViewById(R.id.tv_layoutinflater_fishposition_show);
								tv_groupNum.setTextColor(Color.BLACK);
								tv_groupNum.setBackgroundResource(R.drawable.bgd_diaowei_default);
							}
							
							positionView = view;
							
							TextView tv_groupNum2 = (TextView) positionView
									.findViewById(R.id.tv_layoutinflater_fishposition_show);
							tv_groupNum2.setTextColor(Color.WHITE);
							tv_groupNum2.setBackgroundResource(R.drawable.bgd_diaowei_selected);
							currentOrder = Integer.parseInt(tv_groupNum2.getText()
									.toString());
	...
	private void initDataView() {
		...
		LinearLayout.LayoutParams params2 = new LinearLayout.LayoutParams(
				allWidth2, LinearLayout.LayoutParams.MATCH_PARENT);
		...
		grv_fishipitoder_position_group.setSelector(new ColorDrawable(
				Color.TRANSPARENT));
		groupView = grv_fishipitoder_position_group.getChildAt(0);
		grv_fishipitoder_position_group
				.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
							int position, long id) {
						if (null == groupView) {
							groupView = parent.getChildAt(0);
						}
						TextView tv_groupNum = (TextView) groupView
								.findViewById(R.id.btn_groupnum);
						tv_groupNum.setTextColor(Color.BLACK);
						groupView = view;
						TextView tv_groupNum2 = (TextView) groupView
								.findViewById(R.id.btn_groupnum);
						tv_groupNum2.setTextColor(Color.WHITE);
						for (int i = 0; i < groupNum; i++) {
							parent.getChildAt(i).setBackground(null);
						}
						parent.getChildAt(position).setBackgroundResource(
								R.color.appcolor);
						if ((fishPositionTotal - 28 * position) >= 28) {
							adapter3 = new FishPositionShowAdapter(
									FishpitConfirmOrderActivity.this, 28,
									position, orderedLocations);
							adapter3.setCurrentOrder(currentOrder);
	...
	private void initDates() {
		...
		View v = LayoutInflater.from(getApplicationContext()).inflate(
				R.layout.item_yuyue_fishpit_date, null);
		...
		for (int i = 1; i < 5; i++) {
			...
			View v2 = LayoutInflater.from(getApplicationContext()).inflate(
					R.layout.item_yuyue_fishpit_date, null);
			TextView tv_date2 = (TextView) v2
					.findViewById(R.id.tv_item_yuyue_fishfit_date);
	...
	public void onClick(View v) {
		...
		case R.id.tv_fishpitconfirmorder_confirm:
			...
			HttpUtil.getJSON(
					HttpAddress.ADDRESS + HttpAddress.PROJECT
							+ HttpAddress.CLASS_APPORDER
							+ HttpAddress.METHOD_MAKEORDER, params,
							...
							case 2000:
								...
								try {
									JSONObject jsonObject2 = jsonObject
											.getJSONObject("order");
									userPoint = sp.getString("userPoint", "");
									totalFee = jsonObject2
											.getString("totalFee");
									SharedPreferences sp = getSharedPreferences(
											"user", Context.MODE_PRIVATE);
									phoneNumber = sp.getString("phoneNumber",
											"");
									tokenString = jsonObject2
											.getString("token");
									orderIdString = jsonObject2
											.getString("orderId");
									merchantIdString = jsonObject2
											.getString("merchantId");
									reserveTime = jsonObject2
											.getString("reserveTime");
								...
								bundle.putString("location", currentOrder + "");
								bundle.putString("name", nameString);
								bundle.putString("phone", phoneNumber);
								bundle.putString("totalFee", totalFee);
								bundle.putString("userPoint", userPoint);
